    ...
    },
    {
        ...
        features: [
            ...
            },
            {
                ...
                status: "DONE",
                notes: "In-app password change endpoint (POST /api/auth/change-password) and interactive profile form verified with bcrypt and validation",
            },
            {
        ...
        features: [
            {
                ...
                status: "DONE",
                notes: "System module catalog established in modules.config.js cleanly separating Core from future business modules",
            },
            {
                ...
                status: "DONE",
                notes: "Role and permission based module gating utilities (isModuleEnabled, canUserAccessModule) implemented and verified",
            },
            {
                ...
                status: "DONE",
                notes: "GET /api/v1/modules endpoint resolves enabled and accessible modules tailored to authenticated user context",
            },
            {
                ...
                status: "DONE",
                notes: "Module availability detection API (GET /api/v1/modules/:key) and lookup helper verified with integration tests",
            },
        ],
    },
];
